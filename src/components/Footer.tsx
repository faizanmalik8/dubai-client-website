  ...
  return (
    <footer className={styles.footer}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.links}>
              ...
              <li><a href="https://wa.me/447412300833" target="_blank" rel="noopener noreferrer">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.links}>
              ...
              <li><Link href="/legal/dmca">DMCA Policy</Link></li>
            </ul>
          </div>
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.links}>
              <li>Email: info@iptvdubai.org</li>
              <li>Email: support@iptvdubai.org</li>
      ...
      <div className={styles.bottomBar}>
        <div className={styles.container}>
          <p>&copy; {currentYear} IPTV Dubai. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
